...
server.tool(
  'calculate_realtime_cmv',
  'Calcula o Custo de Mercadorias Vendidas (CMV) exato e a margem bruta de um prato.',
  {
...
server.tool(
  'audit_thermal_limits',
  'Audita a segurança alimentar e conformidade térmica da embalagem estucada de 360imprimir (Limite 100°C).',
  {
...
server.tool(
  'audit_loss_leader_ratio',
  'Analisa a proporção de vendas do Produto Âncora e avalia risco de erosão de lucros.',
  {
