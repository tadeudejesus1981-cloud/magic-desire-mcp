...
server.tool(
  'query_fleet_gps_telemetry',
  'Chama via Axios o endpoint GET https://api.shipday.com/carriers para obter a telemetria GPS da frota ativa.',
  {},
  async () => {
    try {
...
server.tool(
  'assign_shipday_driver',
  'Envia um POST para o endpoint /on-demand/assign do ShipDay para atribuir um entregador a um pedido.',
  {
...
server.tool(
  'update_delivery_eta',
  'Atualiza a tabela orders no Supabase para recalibrar o ETA do Live Tracking do cliente.',
  {
...
server.tool(
  'predict_oven_queue',
  'Previsor de estrangulamento dos fornos de velocidade, com base no número de itens em fila e fornos ativos.',
  {
